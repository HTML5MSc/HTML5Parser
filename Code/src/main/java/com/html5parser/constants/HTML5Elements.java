...
public class HTML5Elements {

	public static final String[] FORMATTING = { "a", "b", "big", "code", "em",
			"font", "i", "nobr", "s", "small", "strike", "strong", "tt", "u" };

	public static final String[] SPECIAL = { "address", "applet", "area",
			"article", "aside", "base", "basefont", "bgsound", "blockquote",
			"body", "br", "button", "caption", "center", "col", "colgroup",
			...
			"listing", "main", "marquee", "meta", "nav", "noembed", "noframes",
